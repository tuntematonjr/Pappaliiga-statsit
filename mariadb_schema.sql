...
CREATE TABLE IF NOT EXISTS player_stats (
    ...
    kills SMALLINT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."Kills"')) AS SIGNED), 0)) VIRTUAL,
    deaths SMALLINT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."Deaths"')) AS SIGNED), 0)) VIRTUAL,
    assists SMALLINT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."Assists"')) AS SIGNED), 0)) VIRTUAL,
    mvps SMALLINT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."MVPs"')) AS SIGNED), 0)) VIRTUAL,
    sniper_kills SMALLINT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."Sniper Kills"')) AS SIGNED), 0)) VIRTUAL,
    enemies_flashed SMALLINT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."Enemies Flashed"')) AS SIGNED), 0)) VIRTUAL,
    flash_count SMALLINT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."Flash Count"')) AS SIGNED), 0)) VIRTUAL,
    flash_successes SMALLINT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."Flash Successes"')) AS SIGNED), 0)) VIRTUAL,
    mk_2k SMALLINT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."Double Kills"')) AS SIGNED), 0)) VIRTUAL,
    mk_3k SMALLINT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."Triple Kills"')) AS SIGNED), 0)) VIRTUAL,
    mk_4k SMALLINT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."Quadro Kills"')) AS SIGNED), 0)) VIRTUAL,
    mk_5k SMALLINT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."Penta Kills"')) AS SIGNED), 0)) VIRTUAL,
    clutch_kills SMALLINT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."Clutch Kills"')) AS SIGNED), 0)) VIRTUAL,
    cl_1v1_attempts SMALLINT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."1v1Count"')) AS SIGNED), 0)) VIRTUAL,
    cl_1v1_wins SMALLINT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."1v1Wins"')) AS SIGNED), 0)) VIRTUAL,
    cl_1v2_attempts SMALLINT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."1v2Count"')) AS SIGNED), 0)) VIRTUAL,
    cl_1v2_wins SMALLINT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."1v2Wins"')) AS SIGNED), 0)) VIRTUAL,
    entry_count SMALLINT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."Entry Count"')) AS SIGNED), 0)) VIRTUAL,
    entry_wins SMALLINT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."Entry Wins"')) AS SIGNED), 0)) VIRTUAL,
    pistol_kills SMALLINT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."Pistol Kills"')) AS SIGNED), 0)) VIRTUAL,
    kd FLOAT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."K/D Ratio"')) AS DECIMAL(10,3)), 0)) VIRTUAL,
    kr FLOAT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."K/R Ratio"')) AS DECIMAL(10,3)), 0)) VIRTUAL,
    adr FLOAT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."ADR"')) AS DECIMAL(10,3)), 0)) VIRTUAL,
    hs_pct DECIMAL(6,3) AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."Headshots %"')) AS DECIMAL(10,3)), 0)) VIRTUAL,
    utility_damage INT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."Utility Damage"')) AS SIGNED), 0)) VIRTUAL,
    damage INT AS (COALESCE(CAST(JSON_UNQUOTE(JSON_EXTRACT(stats_json, '$."Damage"')) AS SIGNED), 0)) VIRTUAL,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
